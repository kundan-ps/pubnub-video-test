...
const turnApiUrl = 'https://pubsub.pubnub.com/v1/blocks/sub-key/sub-c-fc0b34b2-f4a9-11e9-9d2a-9abbdb5d0da2/turn-credentials';
let turnToken;
...
const initWebRtcApp = () => {
    ...
    pubnub = new PubNub({
        publishKey : 'pub-c-7702363c-a916-42d6-89b0-c58af4907f9d',
        subscribeKey : 'sub-c-fc0b34b2-f4a9-11e9-9d2a-9abbdb5d0da2'
    });
